...
const BootcampSchema = new mongoose.Schema(
  {
    ...
    slug: String, // URL friendly version of a name:  G I JOE  =>  g-i-joe
    description: {
      type: String,
...
BootcampSchema.pre('save', async function(next) {
  const loc = await geocoder.geocode(this.address); //.geocode is asynchronous
  this.location = {
    type: 'Point',
  ...
  // Do not save address in DB: i dont need it because I have formatted address
